...
var APP_PLANS = {
  ...
  busqueda_puntual: {
    ...
    stripeProductId: 'prod_SP3ceC9zv6TSJO',
    // Product ID de Stripe para Búsqueda Puntual (Prueba)
    stripePriceId: 'price_1RUFVEA5iob5uvoTOCXpgQtD',
    // Price ID de Stripe para Búsqueda Puntual (Prueba)
  ...
  profesional_monthly: {
    ...
    stripeProductId: 'prod_SP3bTBrf7tFsyt',
    // Product ID de Stripe para Plan Profesional (Prueba)
    stripePriceId: 'price_1RUFUfA5iob5uvoTwfgZtdfi',
    // Price ID de Stripe para Plan Profesional (Prueba)
