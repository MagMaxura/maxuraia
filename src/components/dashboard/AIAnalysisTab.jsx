  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <Dialog open={isProfileModalOpen} onOpenChange={setIsProfileModalOpen}>
        <DialogContent className="w-full max-w-full sm:max-w-[90vw] md:max-w-[1400px] lg:max-w-screen-2xl max-h-[90vh] overflow-y-auto relative"> {/* Aumentar el ancho del modal para ser más responsive */}
          <DialogHeader>
            <DialogTitle>
