...
if (typeof window !== 'undefined' && window.Paddle) {
  ...
  const paddleEnvironment = import.meta.env.VITE_PADDLE_ENV || 'sandbox'; // 'sandbox' o 'live'

  if (import.meta.env.VITE_PADDLE_CLIENT_TOKEN) {
    console.log("PADDLE_CLIENT_TOKEN:", import.meta.env.VITE_PADDLE_CLIENT_TOKEN);
