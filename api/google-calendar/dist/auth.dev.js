...
var HARDCODED_REDIRECT_URI = 'https://www.employsmartia.com/api/google-calendar/auth'; // URL hardcodeada para prueba

var redirectUriCleaned = HARDCODED_REDIRECT_URI.replace(/\/$/, '');
console.log('Backend Google Redirect URI (cleaned - hardcoded):', redirectUriCleaned); // Log para verificar la URI final

var oauth2Client = new _googleapis.google.auth.OAuth2(GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, encodeURIComponent(redirectUriCleaned) // Codificar la URI para asegurar compatibilidad
);
