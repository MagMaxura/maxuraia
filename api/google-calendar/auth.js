...
const HARDCODED_REDIRECT_URI = 'https://www.employsmartia.com/api/google-calendar/auth'; // URL hardcodeada para prueba

const redirectUriCleaned = HARDCODED_REDIRECT_URI.replace(/\/$/, '');
